...
### Fixed
- Typed mailbox subscriptions now honor sticky replay like the named and GUID mailbox paths, and the regression suite now pins mailbox close, delayed-overflow, closed-mailbox `PostResult`, and raw-thread zero-window clear boundaries.
